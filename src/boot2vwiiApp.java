...
public class boot2vwiiApp 
{
	...
	public static void main(String[] args) throws ClassNotFoundException, InstantiationException, IllegalAccessException, UnsupportedLookAndFeelException
	{
		...
		JTextField TIDHIGH = new JTextField("0x");
		...
		JTextField TIDLOW = new JTextField("0x");
		...
		compileBtn.addActionListener(new ActionListener()
		{
			public void actionPerformed(ActionEvent e) 
			{
				...
				code += TIDHIGH.getText().equals("") || TIDLOW.getText().equals("0x") ? "" : " TIDHIGH=" + TIDHIGH.getText();
				code += TIDLOW.getText().equals("") || TIDLOW.getText().equals("0x")? "" : " TIDLOW=" + TIDLOW.getText();
